...
?>
            ...
            <td> 
              <a href="/dashboards/edit_user/<?=$user['id']?>" class="btn btn-warning">Edit</a>
            </td>
            <td>
<?php         
            if($user['user_level']=="9")
            {
?>
              <a href="" class="btn btn-danger" disabled>Admin</a>     
<?php         
            }
            else
            {
?>
              <a href="/users/delete_user/<?=$user['id']?>" class="btn btn-danger">Delete</a>
<?php   
            }
?>
            </td>
